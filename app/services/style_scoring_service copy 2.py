...
class StyleScoringService:
    ...
    def analyze_outfit(self, outfit_images: dict[str, bytes], outfit_metadata: dict[str, dict], target_mood: str = None) -> StyleScore:
        """
        ...
        if target_mood:
             ...
             2. Mood / Occasion Analysis:
                - The user tried to dress for the following occasion: "{target_mood}".
                - DETECT the detected mood from the combined outfit.
                - COMPARE the detected mood with the target mood "{target_mood}".
                - If they match, award higher scores. If they clash, deduct points.
                - In 'mood_analysis', explicitly discuss how well the outfit fits the '{target_mood}' occasion.
             """
        else:
             mood_instruction = """
