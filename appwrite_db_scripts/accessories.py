...
def setup_accessories(db_service: Databases, db_id: str):
    coll_name = "Accessories"
    coll_id = "accessories"
    ...
    create_attr(db_service.create_string_attribute, db_id, coll_id, "specific_category", 128, required=True)
